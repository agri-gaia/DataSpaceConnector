...
public class MinioDeprovisionPipeline {

    private final RetryPolicy<Object> retryPolicy;
    private final MinioClientProvider clientProvider;
    private final Monitor monitor;

    public MinioDeprovisionPipeline(RetryPolicy<Object> retryPolicy, MinioClientProvider clientProvider, Monitor monitor) {
     ...
     */
    public CompletableFuture<?> deprovision(MinioBucketProvisionedResource resource) {
    ...
    static class Builder {
        ...
        public MinioDeprovisionPipeline build() {
            Objects.requireNonNull(retryPolicy);
            Objects.requireNonNull(clientProvider);
            Objects.requireNonNull(monitor);
            return new MinioDeprovisionPipeline(retryPolicy, clientProvider, monitor);
        }
    }
}
