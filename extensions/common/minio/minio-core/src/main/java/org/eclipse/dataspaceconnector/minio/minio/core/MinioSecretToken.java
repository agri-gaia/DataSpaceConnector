...
public class MinioSecretToken implements SecretToken {
    private final String accessKeyId;
    private final String secretAccessKey;

    public MinioSecretToken(@JsonProperty("accessKeyId") String accessKeyId, @JsonProperty("secretAccessKey") String secretAccessKey) {
    ...
    public boolean equals(Object o) {
        ...
        MinioSecretToken that = (MinioSecretToken) o;
