...
public interface MinioClientProvider {
    ...
    /**
     * Returns the client for the specified endpoint with the secret token credentials
     */
    S3Client s3Client(String region, SecretToken secretToken, String endpoint);
    ...
    BasicAWSCredentials admin_credentials();

    String getBaseEndpointOverride();
