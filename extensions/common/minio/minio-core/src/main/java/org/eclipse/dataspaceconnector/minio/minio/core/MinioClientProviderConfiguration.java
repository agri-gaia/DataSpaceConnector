...
public class MinioClientProviderConfiguration {
    ...
    private MinioClientProviderConfiguration() {
    ...
    public static class Builder {
        ...
        private final MinioClientProviderConfiguration configuration = new MinioClientProviderConfiguration();
        ...
        public MinioClientProviderConfiguration build() {
