...
class MinioDataSource implements DataSource {

    private String bucketName;
    private String keyName;
    private S3Client client;

    private MinioDataSource() { }
    ...
    public static class Builder {
        private final MinioDataSource source;

        private Builder() {
            source = new MinioDataSource();
        }
